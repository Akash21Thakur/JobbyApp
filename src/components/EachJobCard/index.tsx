...
import { CompanyHeader, CompanyLogo, DescriptionDiv, DescriptionPara, Detail, Icons, JobDescription,  LocationType, LocationTypePackageDiv, Package, StarAndValue, StarIcon, StarValue, Title, TitleAndStars, Type, VisitDiv, Wrapper } from "./styleComponents";
...
const EachJobCard = (props: Props) =>{
    ...
    <Wrapper>
        ...
        <JobDescription>
            ...
            <Link to={data.companyWebsiteUrl} className='link' target="_blank">
            <VisitDiv>
            <Type>Visit</Type> 
